...
<body>
  ...
  <a href="https://github.com/MSKNET/Url-Shorten-Worker/" target="_self">Fork me on GitHub</a>
</body>`
...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://msknet.github.io/Url-Shorten-Worker/"+config.theme+"/index.html")
  ...
  if (location) {
    if (config.safe_browsing_api_key){
      if(!(await is_url_safe(location))){
        let warning_page = await fetch("https://msknet.github.io/Url-Shorten-Worker/safe-browsing.html")
    ...
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://msknet.github.io/Url-Shorten-Worker/no-ref.html")
